export const blackholePairAPIV2Version = "mainnet-1.0.0";

export const blackholePairAPIV2Address = "0xFf39C52b6649aF0f73c8D3088344436a5E3B2fB6";

export const blackholePairAPIV2Abi = [
  {
    inputs: [
      {
