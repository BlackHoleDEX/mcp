export const algebraPoolAPIVersion = "mainnet-1.0.0";

export const algebraPoolAPIAddress = "0xF0274C793D16713338AF4b8BF2BEf64BA2485B99";
export const legacyAlgebraPoolAPIAddress = "0x6cDC88fdd9695FcE81c3d09471feD66D0e5F8C3E";

export const algebraPoolAPIAbi = [
  {
    anonymous: false,
    inputs: [
      {
